	...
	return (
		<div className="prose dark:prose-invert lg:prose-xl">
			...
			<p>
				...
				'as-is' and without any warranty or guarantee. While we make every
				effort to ensure the functionality, security, and reliability of our
				site, we do not make any representations or warranties regarding the
			...
			<p>
				...
				<Link to="/settings/profile">settings</Link> page and deleting your
				account. Just note that once your account is delete, there is no way to
				recover your data.
			</p>
			...
			<p>
				...
				website's uptime may be subject to occasional interruptions, including
				maintenance, updates, or unforeseen technical issues. Your use of this
				service is at your own risk, and we do not guarantee uninterrupted
			...
			<p>
				...
				<Link to="/privacy-policy">Privacy Policy</Link>, which is an integral
			...
			<p>
				...
				efforts to enhance features and address any bugs. It's important to be
				aware of the following regarding features and bugs:
			</p>
			<p>
			...
			<p>
				...
				of project plans. It's crucial to note that these third-party services
				are independent entities, and we are not responsible for their
			...
			<p>
				...
				your own country concerning the use of AI-generated assets and plans.
				Compliance with local laws and regulations is essential, and you
				acknowledge that we do not assume responsibility for any legal
				implications arising from your use of the service.
			</p>
			<p>
				<strong>Continuous Improvement:</strong> While we strive to provide
				accurate and valuable AI-generated content, it's important to understand
				that AI systems are continually evolving. We appreciate your feedback in
				enhancing the quality of our AI-generated plans.
			</p>
			...
			<p>
				<strong>Review of Terms:</strong> It's advisable to review these terms
				regularly to ensure that you are aware of any changes that may affect
				your use of the application. Your continued use of the service after
				updates indicates your agreement to be bound by the modified terms.
			</p>
			<p>Last Modified: 10/01/2024</p>
		</div>
	);
}
