  ...
  strict(message) {
    ...
    return new ZodObject({
      ...
      ...message !== void 0 ? {
        errorMap: (issue, ctx) => {
          var _a, _b, _c8, _d;
          const defaultError = (_c8 = (_b = (_a = this._def).errorMap) === null || _b === void 0 ? void 0 : _b.call(_a, issue, ctx).message) !== null && _c8 !== void 0 ? _c8 : ctx.defaultError;
...
function flatten(data, options) {
  ...
  function setResult(data2, name) {
    var value = simplify(resolve(data2));
...
function replySubmission(context) {
  ...
  var extraError = "formErrors" in options || "fieldErrors" in options ? simplify(_objectSpread22({
    "": options.formErrors
  }, options.fieldErrors)) : null;
  var error = simplify(_objectSpread22(_objectSpread22({}, submissionError), extraError));
  return {
...
// app/shared/lib/hooks/useDebounce/useDebounce.tsx
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1706588338074.856";
}
...
// app/shared/lib/hooks/useIsPending/useIsPending.tsx
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/shared/lib/hooks/useIsPending/useIsPending.tsx"
  );
  import.meta.hot.lastModified = "1706588338075.4417";
}
...
// app/shared/lib/hooks/useOptionalUser/useOptionalUser.tsx
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/shared/lib/hooks/useOptionalUser/useOptionalUser.tsx"
  );
  import.meta.hot.lastModified = "1706588338075.5776";
}
...
// app/shared/lib/hooks/useUser/useUser.tsx
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/shared/lib/hooks/useUser/useUser.tsx"
  );
  import.meta.hot.lastModified = "1706588338076.1628";
}
function useUser() {
...
// app/shared/lib/hooks/useDoubleCheck/useDoubleCheck.tsx
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1706588338075.1655";
}
function callAll(...fns) {
  return (...args) => fns.forEach((fn) => fn?.(...args));
}
function useDoubleCheck() {
  const [doubleCheck, setDoubleCheck] = (0, import_react4.useState)(false);
...
// app/shared/schemas/ThemeFormSchema/ThemeFormSchema.ts
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/shared/schemas/ThemeFormSchema/ThemeFormSchema.ts"
  );
  import.meta.hot.lastModified = "1706588338078.982";
}
var ThemeFormSchema = z.object({
  theme: z.enum(["light", "dark", "system"])
});

// app/shared/schemas/UserValidationSchemas/UserValidationSchemas.ts
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/shared/schemas/UserValidationSchemas/UserValidationSchemas.ts"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1706588338079.2163";
}
...
// app/shared/schemas/DeleteBookSchema/DeleteBookSchema.ts
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/shared/schemas/DeleteBookSchema/DeleteBookSchema.ts"
  );
  import.meta.hot.lastModified = "1706588338078.5652";
}
var DELETE_BOOK_INTENT = "delete-book";
var DeleteBookFormSchema = z.object({
  intent: z.literal(DELETE_BOOK_INTENT),
  bookId: z.string()
});

// app/shared/schemas/DeleteExpenseSchema/DeleteExpenseSchema.ts
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/shared/schemas/DeleteExpenseSchema/DeleteExpenseSchema.ts"
  );
  import.meta.hot.lastModified = "1706588338078.7224";
}
var DELETE_EXPENSE_INTENT = "delete-expense";
var DeleteExpenseFormSchema = z.object({
  intent: z.literal(DELETE_EXPENSE_INTENT),
  expenseId: z.string()
});

// app/shared/schemas/common/common.ts
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/shared/schemas/common/common.ts"
  );
  import.meta.hot.lastModified = "1706588338079.3828";
}
var BreadcrumbHandle = z.object({ breadcrumb: z.any() });
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1706588338079.4893";
}
...
// app/core/utils/clientHints/clientHints.tsx
var import_react8 = __toESM(require_react(), 1);

// app/shared/lib/hooks/useSubmitting/useSubmitting.tsx
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/shared/lib/hooks/useSubmitting/useSubmitting.tsx"
  );
  import.meta.hot.lastModified = "1706588338075.875";
}
...
// app/shared/lib/hooks/useRequestInfo/useRequestInfo.tsx
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/shared/lib/hooks/useRequestInfo/useRequestInfo.tsx"
  );
  import.meta.hot.lastModified = "1706962583488.406";
}
function useRequestInfo() {
  const data = useRouteLoaderData("root");
  invariant2(data?.requestInfo, "No requestInfo found in root loader");
  return data.requestInfo;
}

// app/shared/lib/hooks/index.ts
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/shared/lib/hooks/index.ts"
  );
  import.meta.hot.lastModified = "1706588338074.7097";
}
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/core/utils/clientHints/clientHints.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1706588338060.3328";
}
...
_s(useHints, "7GAbGGZBfQ5CZ09LzgbRSVzv82k=", false, function() {
...
function ClientHintCheck({
  ...
  (0, import_react8.useEffect)(() => subscribeToSchemeChange(() => revalidate()), [revalidate]);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("script", { nonce, dangerouslySetInnerHTML: {
    __html: hintsUtils.getClientHintCheckScript()
  } }, void 0, false, {
    fileName: "app/core/utils/clientHints/clientHints.tsx",
    lineNumber: 67,
    columnNumber: 10
  }, this);
}
_s2(ClientHintCheck, "L1dc0F01n381QK//sAnvnvJbeZg=", false, function() {
  return [useRevalidator];
});
_c7 = ClientHintCheck;
var _c7;
$RefreshReg$(_c7, "ClientHintCheck");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;

// app/core/utils/nonce/nonce.ts
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1706588338060.8418";
}
var NonceContext = React.createContext("");
var NonceProvider = NonceContext.Provider;
var useNonce = () => React.useContext(NonceContext);

// app/core/utils/user/user.ts
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/core/utils/user/user.ts"
  );
  import.meta.hot.lastModified = "1706962574080.1187";
}
...
// app/core/utils/index.ts
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/core/utils/index.ts"
  );
  import.meta.hot.lastModified = "1706962574079.9358";
}

// app/shared/lib/hooks/useTheme/useTheme.tsx
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/shared/lib/hooks/useTheme/useTheme.tsx"
  );
  import.meta.hot.lastModified = "1706962583488.6277";
}
function useTheme() {
...
//# sourceMappingURL=/build/_shared/chunk-O6I6CHNL.js.map
